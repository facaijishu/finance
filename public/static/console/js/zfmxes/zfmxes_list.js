            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, fnRowCallback) {
                ...
                if (aData.zfmx_examine == 1) {
                    ...
                    if(aData.zfmx_exhibition == 1){
                        ...
                        $('td:eq(8)', nRow).append('<a href="javascript:void(0);" data-id="' + aData.id + '" class="btn btn-xs btn-primary js-start cale">展示</a>');
                    }
                    ...
                    if(aData.zfmx_sign == 1){
                        $('td:eq(6)', nRow).html("<div class='badge bg-color-green'>是</div>");
                    }else{
                        $('td:eq(6)', nRow).html("<div class='badge bg-color-clue'>否</div>");
                    }
                }else{
