...
$(document).ready(function () {
    ...
    loadModule(['dataTable'], function () {
        ...
        through_table = throughTbl.DataTable($.extend(true,{}, dtAutoOption(throughTbl), {
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, fnRowCallback) {
                ...
                $('td:eq(7)', nRow).html("<div class='badge bg-color-green'>已审核</div>");
               /* $('td:eq(4)', nRow).html('<img style="width:60px;cursor:pointer;" src="'+root_path_url+'/home/card/'+aData.card+'" data-toggle="modal" data-target="#ModalImg">');*/
    ...
    $(".export").on("click",function(){
        ...
        window.location.href = "http://fin.jrfacai.com/console/through/through_audited_client?real_name="+real_name+"&phone="
                                +phone;
    });
});
