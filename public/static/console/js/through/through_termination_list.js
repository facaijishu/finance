    ...
    loadModule(['dataTable'], function () {
        ...
        through_table = throughTbl.DataTable($.extend(true,{}, dtAutoOption(throughTbl), {
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, fnRowCallback) {
                ...
                $('td:eq(7)', nRow).html("<div class='badge bg-color-red'>已终止</div>");
                ...
                $('td:eq(8)', nRow).append('<a href="javascript:void(0);" data-id="' + aData.t_id + '" class="btn btn-xs btn-success js-start cale">还原</a>');
                return nRow;
            }
        }));
