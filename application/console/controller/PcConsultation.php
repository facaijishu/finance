...
class PcConsultation extends ConsoleBase{
    public function index(){
        $model = model("dict");
        $list = $model->getDictByType('pc_consultation');
    ...
    public function read(){
        ...
        $consultation = model('PcConsultation');
        //搜索条件
    ...
    public function add(){
        if(request()->isPost()){
            ...
            if($consultation->createConsultation(input())){
                $data['url'] = url('PcConsultation/index');
            ...
            $model = model("dict");
            $consultation = $model->getDictByType('pc_consultation');
