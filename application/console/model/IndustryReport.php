...
{
    public function getReportInfoById($id){
    ...
    public function createReport($data){
        ...
        //验证数据信息
        $validate = validate('IndustryReport');
    ...
    public function hotTrueReport($id){
        if(empty($id)){
            $this->error = '该资讯id不存在';
            return false;
        }
    ...
    public function hotFalseReport($id){
        if(empty($id)){
            $this->error = '该资讯id不存在';
            return false;
        }
