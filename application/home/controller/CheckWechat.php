            ...
            case Wechat::MSGTYPE_EVENT:
                ...
                if($result['event'] == 'subscribe' || $result['event'] == 'SCAN'){
                    if($result['event'] == 'subscribe'){
                        ...
                        if(empty($id)){
                            $project = model("Project")->where("status != 1 and flag = 1")->order("pro_id desc")->limit(1)->select();
                            $id = $project[0]['qr_code'];
                        }
                    ...
                    $data = [
                        [
                            ...
                            "Url" => $send['Url'],
                            "PicUrl" => 'http://'.$_SERVER['SERVER_NAME'].'/uploads/'.$send['top_img']
                        ],
                        [
                            "Title" => $title,
                            "Description" => '',
